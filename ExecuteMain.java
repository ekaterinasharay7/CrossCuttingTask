...
public class ExecuteMain {
    ...
    public static void executeMain() throws IOException, NoSuchAlgorithmException, InvalidKeySpecException, NoSuchPaddingException, InvalidAlgorithmParameterException, InvalidKeyException {
        ...
        //сделать так, чтобы ответ не зависел от регистра!!
        ...
        //используем алгоритм PBE (Password-Based Encryption)
